...
with DAG(
    dag_id="fxr_postgres_to_bigquery_journaled_trade_daily",
    description=(
        "Carga incremental diaria desde PostgreSQL FXR hacia BigQuery raw y "
        "final para journal.journaled_trade."
    ),
