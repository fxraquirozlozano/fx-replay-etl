...
with DAG(
    dag_id="fxr_postgres_to_bigquery_journaled_trade_backfill",
    description=(
        "Backfill manual para journal.journaled_trade hacia BigQuery raw y "
        "final. Soporta dag_run.conf con start_timestamp y end_timestamp."
    ),
